...
###
create a dedicated role if auth issues just like in karpenter (karpenter conroller policy)
#
https://dev.to/carlocolumna/keda-in-amazon-eks-part-2-scale-based-on-aws-sqs-queue-5g4d
#
...
EOF
#
aws iam create-role --role-name "keda-operator" --assume-role-policy-document file://keda-trust-policy.json
#
...
(values.yml)
#
https://github.com/kedacore/charts/issues/361
